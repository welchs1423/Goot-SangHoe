...
<body>
	...
	<h2>${checkCategory.pcatname}</h2><br>
		...
		<nav id="bo_cate">
	        <ul id="bo_cate_ul">
	            <li><a href="/categorylist?amount=18&pageNum=1&pcategory=${winepage.cri.pcategory }" id="bo_cate_on" class="categoryall">전체</a></li>
	            <li><a href="10" class="categorymove">미국</a></li>
	            <li><a href="20" class="categorymove">영국</a></li>
	            <li><a href="30" class="categorymove">이탈리아</a></li>
	            <li><a href="40" class="categorymove">프랑스</a></li>
	            <li><a href="50" class="categorymove">독일</a></li>
	            <li><a href="60" class="categorymove">일본</a></li>
	            <li><a href="70" class="categorymove">대만</a></li>
	            <li><a href="80" class="categorymove">아일랜드</a></li>
	            <li><a href="90" class="categorymove">대한민국</a></li>
	            <li><a href="100" class="categorymove">캐나다</a></li>
			</ul>
	    </nav>
