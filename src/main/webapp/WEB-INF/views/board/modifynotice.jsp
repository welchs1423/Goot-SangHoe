...
<form action="/board/modifynotice" method="post" role="form">
<article id="bo_v" style="width:100%">
	<input type="hidden" name="nno" value="${getnotice.nno}">
    <header>
        <h1 id="bo_v_title">제목 : <input type="text" name="title" value="${getnotice.title }"></h1>
    </header>
    ...
    <section id="bo_v_atc">
        ...
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con">
        <p><b><span style="font-size:18pt;"><textarea name="content">${getnotice.content}</textarea></span></b></p></div>
                <!-- } 본문 내용 끝 -->
