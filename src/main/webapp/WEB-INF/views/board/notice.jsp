...
<!-- } 게시판 검색 끝 -->
    ...
    <div class="bo_fx">
        <div id="bo_list_total">
            <span>Total ${noticemaker.total }건</span>
            ${noticemaker.cri.pageNum} 페이지 <a href="" style="text-align:right;"><input type="button" id="regBtn" value="게시글 작성"></a>
        </div>
    ...
    <div class="tbl_head01 tbl_wrap">
       ...
       <tbody>
        <c:forEach var="notice" items="${noticelist }">
        	<tr class="">
            	<td class="td_num boardNo">${notice.nno }</td>
					<td class="td_subject">
                		<span style="font-size:16px;font-weight:bold;">
				
                <a href="${notice.nno }" style="color:#000;" class="move">
                    ${notice.title }                                    </a>

                </span>
                 <br><span style="font-size:12px"><span class="sv_member">최고관리자</span></span><span style="padding:0 10px;font-size:12px;color:#dbdbdb;"> | </span><span style="font-size:12px">${notice.regdate }</span>
...
<script type="text/javascript">
	$(function(){
		...
		var amount = "${noticemaker.cri.amount}";
		
		$(".move").click(function(e){	// nno 게시글 이동 버튼
			e.preventDefault();
			var nno = $(this).attr("href");
			
			location.href="/board/getnotice?&nno=" + nno;
		});
	
		$("#regBtn").click(function(e){	//	새 게시글 등록 버튼
			e.preventDefault();
    		location.href="/board/nregister?pageNum=1&amount=" + amount;
    	});
