...
<article id="bo_v" style="width:100%">
    ...
    <header>
        <h1 id="bo_v_title">제목 : <input type="text" name="title" value="${getinquiry.title }"></h1>
    </header>

    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        작성자 <strong><span class="sv_member"><input type="text" name="writer" value="${getinquiry.writer }" readonly></span></strong>
    </section>
    ...
    <section id="bo_v_atc">
        ...
        <p><b><span style="font-size:18pt;"><textarea name="content">${getinquiry.content}</textarea></span></b></p></div>
                <!-- } 본문 내용 끝 -->
		 <input type="submit" id="remove" value="삭제하기" class="registerbutton">
